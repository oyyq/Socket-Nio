...
public class SendHeaderFrame extends AbsSendPacketFrame {
    ...
    /**
     * @param pckheadlen  packet header info length
     */
    public SendHeaderFrame(short identifier, SendPacket packet, int pckheadlen) {
        super(PACKET_HEADER_FRAME_MIN_LENGTH+pckheadlen,
    ...
    public Frame buildNextFrame() {
        ...
        if (type == Packet.TYPE_STREAM_DIRECT) {
            ...
            // 普通数据类型
            ReadableByteChannel channel = packet.open();
