...
public class IoArgs {
    ...
    private final boolean isNeedConsumeRemaining;       // 是否需要消费所有的区间（读取、写入）
    ...
    public interface IoArgsEventProcessor {
        ...
        /**
         * 通知外层, 由于外层要求Receiver停止接收SocketChannel的数据, 当前实际接收已经停止
         */
        void notifyReceiveStop();

        /**
         * 通知SocketChannel有新数据到达
         */
        void notifyReceiveStart();


        /**
         * 通知开始发送数据到SocketChannel
         */
        void notifyStartSend();


        /**
         * 通知没有数据可发送到SocketChannel
         */
        void notifyDataFullSent();
